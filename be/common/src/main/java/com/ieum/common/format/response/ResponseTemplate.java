...
public class ResponseTemplate {
     ...
     * @return 응답 객체
     */
    public <T> ResponseEntity<?> success(HttpStatus httpStatus) {
        return get(STATUS_SUCCESS, null, null, null, null, null, null, httpStatus);
    }
     ...
     * @return 응답 객체
     */
    public <T> ResponseEntity<?> pagination(T data, Long page, Integer size, Long total, HttpStatus httpStatus) {
        return get(STATUS_SUCCESS, null, data, null, page, size, total, httpStatus);
    }
     ...
     * @return 응답 객체
     */
    public <T> ResponseEntity<?> pagination(T data, Pageable pageable, Long total, HttpStatus httpStatus) {
     ...
     * @return 응답 객체
     */
    public <T> ResponseEntity<?> fail(String message, HttpStatus httpStatus) {
        return get(STATUS_FAIL, message, null, null, null, null, null, httpStatus);
    }
    ...
    public <E> ResponseEntity<?> fail(String message, E errors, HttpStatus httpStatus) {
        return get(STATUS_FAIL, message, null, errors, null, null, null, httpStatus);
    }
    ...
    public ResponseEntity<?> fail(Errors errors, HttpStatus httpStatus) {
        return fail(null, errors.getAllErrors().stream().map(FieldError::new)
     ...
     * @return 응답 객체
     */
    public ResponseEntity<?> fail(BindingResult bindingResult, HttpStatus httpStatus) {
        return fail((Errors) bindingResult, httpStatus);
    }
    ...
    public <E> ResponseEntity<?> fail(E errors, HttpStatus httpStatus) {
        return get(STATUS_FAIL, null, null, errors, null, null, null, httpStatus);
    }
     ...
     * @return 응답 객체
     */
    public <T> ResponseEntity<?> error(String message, HttpStatus httpStatus) {
        return get(STATUS_ERROR, message, null, null, null, null, null, httpStatus);
    }
